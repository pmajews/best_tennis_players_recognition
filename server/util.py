...
def load_saved_artifacts():
    ...
    with open(r"C:\Users\przem\Desktop\best_tennis_players_recognition\server\artifacts\class_dictionary.json", "r") as f:
        __class_name_to_number = json.load(f)
        __class_number_to_name = {v:k for k,v in __class_name_to_number.items()}

    global __model
    if __model is None:
        with open(r"C:\Users\przem\Desktop\best_tennis_players_recognition\server\artifacts\saved_model.pkl", "rb") as f:
...
if __name__ == '__main__':
    ...
    print(classify_image(None, r"C:\Users\przem\Desktop\Nowy\novak.jpg"))